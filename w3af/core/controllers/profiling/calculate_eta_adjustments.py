...
from w3af.core.controllers.profiling.scan_log_analysis.utils.utils import get_first_timestamp, get_line_epoch
from w3af.core.controllers.profiling.scan_log_analysis.graphs.progress_delta import CRAWL_INFRA_FINISHED, JOIN_TIMES
