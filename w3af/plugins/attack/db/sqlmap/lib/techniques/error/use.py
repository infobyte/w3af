...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CHECK_ZERO_COLUMNS_THRESHOLD
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MIN_ERROR_CHUNK_LENGTH
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MAX_ERROR_CHUNK_LENGTH
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SLOW_ORDER_COUNT_THRESHOLD
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SQL_SCALAR_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import TURN_OFF_RESUME_INFO_LIMIT
