...
from w3af.plugins.attack.db.sqlmap.lib.core.common import extractTextTagContent
from w3af.plugins.attack.db.sqlmap.lib.core.common import findDynamicContent
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import getLastRequestHTTPError
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import getSortedInjectionTests
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import showStaticWords
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CANDIDATE_SENTENCE_MIN_LENGTH
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CHECK_INTERNET_ADDRESS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CHECK_INTERNET_VALUE
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DUMMY_NON_SQLI_CHECK_APPENDIX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import FI_ERROR_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import FORMAT_EXCEPTION_STRINGS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import HEURISTIC_CHECK_ALPHABET
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IDS_WAF_CHECK_PAYLOAD
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IDS_WAF_CHECK_RATIO
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IDS_WAF_CHECK_TIMEOUT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MAX_DIFFLIB_SEQUENCE_LENGTH
from w3af.plugins.attack.db.sqlmap.lib.core.settings import NON_SQLI_CHECK_PREFIX_SUFFIX_LENGTH
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SLEEP_TIME_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SUHOSIN_MAX_VALUE_LENGTH
...
from w3af.plugins.attack.db.sqlmap.lib.request.inject import checkBooleanExpression
from w3af.plugins.attack.db.sqlmap.lib.request.templates import getPageTemplate
from w3af.plugins.attack.db.sqlmap.lib.techniques.union.test import unionTest
from w3af.plugins.attack.db.sqlmap.lib.techniques.union.use import configUnion
