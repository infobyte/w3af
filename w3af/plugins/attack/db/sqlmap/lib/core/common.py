...
from w3af.plugins.attack.db.sqlmap.lib.core.convert import base64pickle
from w3af.plugins.attack.db.sqlmap.lib.core.convert import base64unpickle
from w3af.plugins.attack.db.sqlmap.lib.core.convert import hexdecode
from w3af.plugins.attack.db.sqlmap.lib.core.convert import htmlunescape
from w3af.plugins.attack.db.sqlmap.lib.core.convert import stdoutencode
from w3af.plugins.attack.db.sqlmap.lib.core.convert import unicodeencode
...
from w3af.plugins.attack.db.sqlmap.lib.core.dicts import DEFAULT_DOC_ROOTS
from w3af.plugins.attack.db.sqlmap.lib.core.dicts import DEPRECATED_OPTIONS
from w3af.plugins.attack.db.sqlmap.lib.core.dicts import SQL_STATEMENTS
from w3af.plugins.attack.db.sqlmap.lib.core.enums import ADJUST_TIME_DELAY
...
from w3af.plugins.attack.db.sqlmap.lib.core.enums import HEURISTIC_TEST
...
from w3af.plugins.attack.db.sqlmap.lib.core.enums import REFLECTIVE_COUNTER
from w3af.plugins.attack.db.sqlmap.lib.core.enums import SORT_ORDER
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BANNER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BOLD_PATTERNS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BOUNDED_INJECTION_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BRUTE_DOC_ROOT_PREFIXES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BRUTE_DOC_ROOT_SUFFIXES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BRUTE_DOC_ROOT_TARGET_MARK
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DBMS_DIRECTORY_DICT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CUSTOM_INJECTION_MARK_CHAR
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_COOKIE_DELIMITER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_GET_POST_DELIMITER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_MSSQL_SCHEMA
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEV_EMAIL_ADDRESS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DUMMY_USER_INJECTION
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DYNAMICITY_BOUNDARY_LENGTH
from w3af.plugins.attack.db.sqlmap.lib.core.settings import ERROR_PARSING_REGEXES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import FILE_PATH_REGEXES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import FORCE_COOKIE_EXPIRATION_TIME
from w3af.plugins.attack.db.sqlmap.lib.core.settings import FORM_SEARCH_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import GENERIC_DOC_ROOT_DIRECTORY_NAMES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import GIT_PAGE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import GITHUB_REPORT_OAUTH_TOKEN
from w3af.plugins.attack.db.sqlmap.lib.core.settings import GOOGLE_ANALYTICS_COOKIE_PREFIX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import HASHDB_MILESTONE_VALUE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import HOST_ALIASES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IGNORE_SAVE_OPTIONS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import INFERENCE_UNKNOWN_CHAR
from w3af.plugins.attack.db.sqlmap.lib.core.settings import INVALID_UNICODE_CHAR_FORMAT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IP_ADDRESS_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import ISSUES_PAGE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IS_WIN
from w3af.plugins.attack.db.sqlmap.lib.core.settings import LARGE_OUTPUT_THRESHOLD
from w3af.plugins.attack.db.sqlmap.lib.core.settings import LOCALHOST
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MIN_ENCODED_LEN_CHECK
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MIN_TIME_RESPONSES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MIN_VALID_DELAYED_RESPONSE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import NETSCAPE_FORMAT_HEADER_COOKIES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import NULL
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PARAMETER_AMP_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PARAMETER_SEMICOLON_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PARTIAL_HEX_VALUE_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PARTIAL_VALUE_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PAYLOAD_DELIMITER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PLATFORM
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PRINTABLE_CHAR_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PUSH_VALUE_EXCEPTION_RETRY_COUNT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PYVERSION
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFERER_ALIASES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTED_BORDER_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTED_MAX_REGEX_PARTS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTED_REPLACEMENT_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTED_REPLACEMENT_TIMEOUT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTED_VALUE_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import REFLECTIVE_MISS_THRESHOLD
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SAFE_VARIABLE_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SENSITIVE_DATA_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SENSITIVE_OPTIONS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SUPPORTED_DBMS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import TEXT_TAG_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import TIME_STDEV_COEFF
from w3af.plugins.attack.db.sqlmap.lib.core.settings import UNICODE_ENCODING
from w3af.plugins.attack.db.sqlmap.lib.core.settings import UNKNOWN_DBMS_VERSION
from w3af.plugins.attack.db.sqlmap.lib.core.settings import URI_QUESTION_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import URLENCODE_CHAR_LIMIT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import URLENCODE_FAILSAFE_CHARS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import USER_AGENT_ALIASES
...
from w3af.plugins.attack.db.sqlmap.lib.utils.sqlalchemy import _sqlalchemy
from w3af.plugins.attack.db.sqlmap.thirdparty.clientform.clientform import ParseResponse
from w3af.plugins.attack.db.sqlmap.thirdparty.clientform.clientform import ParseError
...
from w3af.plugins.attack.db.sqlmap.thirdparty.termcolor.termcolor import colored
