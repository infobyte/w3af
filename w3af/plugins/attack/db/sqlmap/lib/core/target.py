...
from w3af.plugins.attack.db.sqlmap.lib.core.common import paramToDict
...
from w3af.plugins.attack.db.sqlmap.lib.core.dump import dumper
...
from w3af.plugins.attack.db.sqlmap.lib.core.option import _setDBMS
from w3af.plugins.attack.db.sqlmap.lib.core.option import _setKnowledgeBaseAttributes
from w3af.plugins.attack.db.sqlmap.lib.core.option import _setAuthCred
from w3af.plugins.attack.db.sqlmap.lib.core.settings import ASTERISK_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CSRF_TOKEN_PARAMETER_INFIXES
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import ARRAY_LIKE_RECOGNITION_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import JSON_RECOGNITION_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import JSON_LIKE_RECOGNITION_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MULTIPART_RECOGNITION_REGEX
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import RESTORE_MERGED_OPTIONS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import RESULTS_FILE_FORMAT
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import XML_RECOGNITION_REGEX
from w3af.plugins.attack.db.sqlmap.lib.utils.hashdb import HashDB
