...
import w3af.plugins.attack.db.sqlmap.lib.controller.checks
import w3af.plugins.attack.db.sqlmap.lib.core.common
import w3af.plugins.attack.db.sqlmap.lib.core.threads
import w3af.plugins.attack.db.sqlmap.lib.core.convert
import w3af.plugins.attack.db.sqlmap.lib.request.connect
import w3af.plugins.attack.db.sqlmap.lib.utils.search

from w3af.plugins.attack.db.sqlmap.lib.controller.checks import checkConnection
from w3af.plugins.attack.db.sqlmap.lib.core.common import Backend
from w3af.plugins.attack.db.sqlmap.lib.core.common import boldifyMessage
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import filterStringValue
from w3af.plugins.attack.db.sqlmap.lib.core.common import findLocalPort
from w3af.plugins.attack.db.sqlmap.lib.core.common import findPageForms
from w3af.plugins.attack.db.sqlmap.lib.core.common import getConsoleWidth
from w3af.plugins.attack.db.sqlmap.lib.core.common import getFileItems
from w3af.plugins.attack.db.sqlmap.lib.core.common import getFileType
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import parseTargetDirect
from w3af.plugins.attack.db.sqlmap.lib.core.common import parseTargetUrl
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import readCachedFileContent
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import safeExpandUser
from w3af.plugins.attack.db.sqlmap.lib.core.common import saveConfig
from w3af.plugins.attack.db.sqlmap.lib.core.common import setOptimize
...
from w3af.plugins.attack.db.sqlmap.lib.core.data import mergedOptions
...
from w3af.plugins.attack.db.sqlmap.lib.core.datatype import InjectionDict
...
from w3af.plugins.attack.db.sqlmap.lib.core.enums import AUTH_TYPE
...
from w3af.plugins.attack.db.sqlmap.lib.core.enums import MOBILES
...
from w3af.plugins.attack.db.sqlmap.lib.core.enums import PROXY_TYPE
from w3af.plugins.attack.db.sqlmap.lib.core.enums import REFLECTIVE_COUNTER
from w3af.plugins.attack.db.sqlmap.lib.core.enums import WIZARD
...
from w3af.plugins.attack.db.sqlmap.lib.core.log import FORMATTER
from w3af.plugins.attack.db.sqlmap.lib.core.optiondict import optDict
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BURP_REQUEST_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import BURP_XML_HISTORY_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import CODECS_LIST_PAGE
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DBMS_ALIASES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_PAGE_ENCODING
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_TOR_HTTP_PORTS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DEFAULT_TOR_SOCKS_PORTS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import DUMMY_URL
from w3af.plugins.attack.db.sqlmap.lib.core.settings import INJECT_HERE_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import IS_WIN
from w3af.plugins.attack.db.sqlmap.lib.core.settings import KB_CHARS_BOUNDARY_CHAR
from w3af.plugins.attack.db.sqlmap.lib.core.settings import KB_CHARS_LOW_FREQUENCY_ALPHABET
from w3af.plugins.attack.db.sqlmap.lib.core.settings import LOCALHOST
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MAX_CONNECT_RETRIES
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PRECONNECT_CANDIDATE_TIMEOUT
from w3af.plugins.attack.db.sqlmap.lib.core.settings import PROBLEMATIC_CUSTOM_INJECTION_PATTERNS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SITE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SOCKET_PRE_CONNECT_QUEUE_SIZE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SQLMAP_ENVIRONMENT_PREFIX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SUPPORTED_DBMS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SUPPORTED_OS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import TIME_DELAY_CANDIDATES
from w3af.plugins.attack.db.sqlmap.lib.core.settings import UNICODE_ENCODING
from w3af.plugins.attack.db.sqlmap.lib.core.settings import UNION_CHAR_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import UNKNOWN_DBMS_VERSION
from w3af.plugins.attack.db.sqlmap.lib.core.settings import URI_INJECTABLE_REGEX
from w3af.plugins.attack.db.sqlmap.lib.core.settings import VERSION_STRING
from w3af.plugins.attack.db.sqlmap.lib.core.settings import WEBSCARAB_SPLITTER
from w3af.plugins.attack.db.sqlmap.lib.core.threads import getCurrentThreadData
from w3af.plugins.attack.db.sqlmap.lib.core.threads import setDaemon
from w3af.plugins.attack.db.sqlmap.lib.core.update import update
from w3af.plugins.attack.db.sqlmap.lib.parse.configfile import configFileParser
from w3af.plugins.attack.db.sqlmap.lib.parse.payloads import loadBoundaries
from w3af.plugins.attack.db.sqlmap.lib.parse.payloads import loadPayloads
from w3af.plugins.attack.db.sqlmap.lib.parse.sitemap import parseSitemap
from w3af.plugins.attack.db.sqlmap.lib.request.basic import checkCharEncoding
from w3af.plugins.attack.db.sqlmap.lib.request.connect import Connect as Request
from w3af.plugins.attack.db.sqlmap.lib.request.dns import DNSServer
from w3af.plugins.attack.db.sqlmap.lib.request.basicauthhandler import SmartHTTPBasicAuthHandler
from w3af.plugins.attack.db.sqlmap.lib.request.httpshandler import HTTPSHandler
from w3af.plugins.attack.db.sqlmap.lib.request.pkihandler import HTTPSPKIAuthHandler
from w3af.plugins.attack.db.sqlmap.lib.request.rangehandler import HTTPRangeHandler
from w3af.plugins.attack.db.sqlmap.lib.request.redirecthandler import SmartRedirectHandler
from w3af.plugins.attack.db.sqlmap.lib.request.templates import getPageTemplate
from w3af.plugins.attack.db.sqlmap.lib.utils.har import HTTPCollectorFactory
from w3af.plugins.attack.db.sqlmap.lib.utils.crawler import crawl
from w3af.plugins.attack.db.sqlmap.lib.utils.deps import checkDependencies
from w3af.plugins.attack.db.sqlmap.lib.utils.search import search
from w3af.plugins.attack.db.sqlmap.lib.utils.purge import purge
from w3af.plugins.attack.db.sqlmap.thirdparty.keepalive import keepalive
from w3af.plugins.attack.db.sqlmap.thirdparty.multipart import multipartpost
    ...
    if conf.tamper:
        ...
        for script in re.split(PARAMETER_SPLITTING_REGEX, conf.tamper):
            ...
            for name, function in inspect.getmembers(module, inspect.isfunction):
                if name == "tamper" and inspect.getfullargspec(function).args and inspect.getfullargspec(function).keywords == "kwargs":
                    found = True
