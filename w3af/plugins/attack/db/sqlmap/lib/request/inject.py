...
from w3af.plugins.attack.db.sqlmap.lib.core.common import cleanQuery
from w3af.plugins.attack.db.sqlmap.lib.core.common import expandAsteriskForColumns
from w3af.plugins.attack.db.sqlmap.lib.core.common import extractExpectedValue
from w3af.plugins.attack.db.sqlmap.lib.core.common import getPublicTypeMembers
from w3af.plugins.attack.db.sqlmap.lib.core.common import getTechniqueData
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import initTechnique
...
from w3af.plugins.attack.db.sqlmap.lib.core.common import parseUnionPage
...
from w3af.plugins.attack.db.sqlmap.lib.core.settings import GET_VALUE_UPPERCASE_KEYWORDS
from w3af.plugins.attack.db.sqlmap.lib.core.settings import INFERENCE_MARKER
from w3af.plugins.attack.db.sqlmap.lib.core.settings import MAX_TECHNIQUES_PER_VALUE
from w3af.plugins.attack.db.sqlmap.lib.core.settings import SQL_SCALAR_REGEX
...
from w3af.plugins.attack.db.sqlmap.lib.techniques.blind.inference import bisection
from w3af.plugins.attack.db.sqlmap.lib.techniques.blind.inference import queryOutputLength
from w3af.plugins.attack.db.sqlmap.lib.techniques.dns.test import dnsTest
from w3af.plugins.attack.db.sqlmap.lib.techniques.dns.use import dnsUse
from w3af.plugins.attack.db.sqlmap.lib.techniques.error.use import errorUse
